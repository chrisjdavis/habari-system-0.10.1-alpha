...
<?php if ( $first_run ):
	$msg = _t('Welcome to Filmio! We hope that you will jump right in and start exploring. If you get stuck or want to learn more about some of the advanced features, we encourage you to read the [manual], which is bundled with every Filmio install. This link also appears at the bottom of every page in the admin area.');
 	$msg = str_replace( array( '[', ']' ), array( '<a href="' . Site::get_url('filmio') . '/doc/manual/index.html" onclick="popUp(this.href);return false;" title="' . _t('Filmio Manual') . '">', '</a>' ), $msg );
?>
