...
<div class="installstep ready" id="databasesetup">
	...
	<div class="options">
		...
		<div class="inputfield">
			...
			<div class="help">
				<?php _e('<strong>Database Type</strong> specifies the type of database to which Filmio will connect.  Changing this setting may affect the other fields that are available here.  If the database engine that you wanted to use is not in this list, you may need to install a PDO driver to enable it.'); ?>
		...
		<div class="inputfield formysql">
			...
			<img class="status" src="<?php Site::out_url( 'filmio' ); ?>/system/installer/images/ready.png" alt="" />
			<div class="warning"><?php echo elem_if_set( $form_errors, 'mysql_db_host'); ?></div>
			<div class="help">
				<?php _e('<strong>Database Host</strong> is the host (domain) name or server IP address of the server that runs the MySQL database to which Filmio will connect.  If MySQL is running on your web server, and most of the time it is, "localhost" is usually a good value for this field.'); ?>
				<a href="#"><?php _e('Learn More&hellip;'); ?></a>
			</div>
		</div>
		...
		<div class="inputfield formysql">
			...
			<div class="help">
				<?php _e('<strong>Database User</strong> is the username used to connect Filmio to the MySQL database.'); ?>
				<a href="#"><?php _e('Learn More&hellip;'); ?></a>
			</div>
		</div>
		...
		<div class="inputfield formysql">
			...
			<div class="help">
				<?php _e('<strong>Database Name</strong> is the name of the MySQL database to which Filmio will connect.'); ?>
				<a href="#"><?php _e('Learn More&hellip;'); ?></a>
			</div>
		</div>
		...
		<div class="inputfield forpgsql">
			...
			<div class="help">
				<?php _e('<strong>Database Host</strong> is the host (domain) name or server IP address of the server that runs the PostgreSQL database to which Filmio will connect.  If PostgreSQL is running on your web server, and most of the time it is, "localhost" is usually a good value for this field.'); ?>
				<a href="#"><?php _e('Learn More&hellip;'); ?></a>
			</div>
		</div>
		...
		<div class="inputfield forpgsql">
			...
			<div class="help">
				<?php _e('<strong>Database User</strong> is the username used to connect Filmio to the PostgreSQL database.'); ?>
				<a href="#"><?php _e('Learn More&hellip;'); ?></a>
			</div>
		</div>
		...
		<div class="inputfield forpgsql">
			...
			<div class="help">
				<?php _e('<strong>Database Name</strong> is the name of the PostgreSQL database to which Filmio will connect.'); ?>
				<a href="#"><?php _e('Learn More&hellip;'); ?></a>
			</div>
		</div>
		...
		<div class="inputfield forsqlite">
			...
			<div class="help">
				<?php _e('<strong>Data file</strong> is the SQLite file that will store your Filmio data.  This should be the path to where your data file resides, relative to the Filmio user directory.'); ?> <a href="#"><?php _e('Learn More&hellip;'); ?></a>
			</div>
		</div>
	</div>
	...
	<div class="advanced-options">
		<div class="inputfield">
			...
			<div class="help">
				<?php _e('<strong>Table Prefix</strong> is a prefix that will be appended to each table that Filmio creates in the database, making it easy to distinguish those tables in the database from those of other installations.'); ?>
				<a href="#"><?php _e('Learn More&hellip;'); ?></a>
			</div>
		</div>
		<div class="inputfield">
...
<div class="installstep ready" id="siteconfiguration">
	...
	<div class="options">
		...
		<div class="inputfield">
			...
			<div class="help">
				<?php _e('<strong>Username</strong> is the username of the initial user in Filmio.'); ?>  <a href="#"><?php _e('Learn More&hellip;'); ?></a>
			</div>
		</div>
		...
		<div class="inputfield">
			...
			<div class="help">
				<?php _e('<strong>Password</strong> is the password of the initial user in Filmio. Both password fields must match.'); ?>  <a href="#"><?php _e('Learn More&hellip;'); ?></a>
			</div>
		</div>
...
<div class="installstep ready" id="install">
	...
	<div class="options">
		<div class="inputfield submit">
			<p><?php _e('Filmio now has all of the information needed to install itself on your server.'); ?></p>
			...
			<input type="submit" name="submit" value="<?php _e('Install Filmio'); ?>" id="submitinstall" tabindex="<?php echo $tab++ ?>" />
		</div>
	</div>
	<div class="bottom"></div>
</div>
...
<script type="text/javascript" src="<?php Site::out_url('filmio'); ?>/system/installer/script.js"></script>
