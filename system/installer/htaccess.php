...
<div class="installstep ready">
	...
	<div class="options">
		<div class="inputfield">
			<?php _e('Your <strong>.htaccess</strong> file is not writable. In order to successfully install Filmio, please paste the following into'); ?> <strong><?php echo FILMIO_PATH . '/.htaccess'; ?></strong>:<br>
			<textarea class="config" tabindex="<?php echo $tab++ ?>"><?php echo $file_contents; ?></textarea>
			<div class="help">
				<?php _e('<strong>.htaccess</strong> is a file that tells your Apache web server to send requests to Filmio for handling. Filmio is not able to write this file to your server automatically, so you must create this file yourself to continue the installation.'); ?>
