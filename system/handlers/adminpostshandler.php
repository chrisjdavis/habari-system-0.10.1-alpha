...
/**
 * Filmio AdminPostsHandler Class
...
class AdminPostsHandler extends AdminHandler
{
	...
	public function ajax_media( $handler_vars )
	{
		...
		$controls = array( 'root' => '<a href="#" onclick="Filmio.media.fullReload();Filmio.media.showdir(\''. $rootpath . '\');return false;">' . _t( 'Root' ) . '</a>' );
	...
	public function ajax_media_upload( $handler_vars )
	{
		...
		$ar = new AjaxResponse();
		$ar->data = $output;
		$ar->out( true ); // See discussion at https://github.com/Filmio/Filmio/issues/204
	}
