...
// 		Update::check_plugins();
	...
	*/
	public function get_sysinfo()
	{
		...
		// Assemble Site Info
		$siteinfo[ _t( 'Filmio Version' ) ] = Version::get_Filmioversion();
		if ( Version::is_devel() ) {
			$siteinfo[ _t( 'Filmio Version' ) ] .= " " . Version::get_git_short_hash();
		}

		$theme_info = Themes::get_active_data( true );
		$siteinfo[ _t( 'Filmio API Version' ) ] = Version::get_apiversion();
		$siteinfo[ _t( 'Filmio DB Version' ) ] = Version::get_dbversion();
		...
		// Assemble Class Info
		$classinfo = Utils::glob( FILMIO_PATH . "/user/classes/*.php" );
		if ( count( $classinfo ) ) {
