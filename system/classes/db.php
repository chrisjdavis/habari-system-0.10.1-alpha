...
class DB extends Singleton
{
	...
	**/
	...
	{
		DB::instance()->connection->set_fetch_class( '\Filmio\Projects\Project' );
	}
	 ...
	 */
	public static function get_results( $query, $args = array(), $class_name = '\Filmio\QueryRecord' )
	{
	 ...
	 **/
	public static function get_row( $query, $args = array(), $class_name = '\Filmio\QueryRecord' )
	{
