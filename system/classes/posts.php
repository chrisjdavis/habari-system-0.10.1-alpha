...
class Posts extends \ArrayObject implements IsContent
{
	 ...
	 * - where => manipulate the generated WHERE clause. Currently broken.
...
*/
	...
	public static function update_scheduled_posts_cronjob()
	{
		...
		if ( $min_time ) {
			CronTab::add_single_cron( 'publish_scheduled_posts', Method::create( '\Filmio\Posts', 'publish_scheduled_posts' ), $min_time, 'Next run: ' . DateTime::create( $min_time )->get( 'c' ) );
		}
	}
