...
class Term extends QueryRecord
{
	...
	public function insert()
	{
		...
		EventLog::log( _t( 'New term %1$s: %2$s', array( $this->id, $this->term_display ) ), 'info', 'content', 'filmio' );
	...
	public function delete()
	{
		...
		EventLog::log( _t( 'Term %1$s (%2$s) deleted.', array( $this->id, $this->term_display ) ), 'info', 'content', 'filmio' );
