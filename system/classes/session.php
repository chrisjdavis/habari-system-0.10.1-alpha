...
class Session extends Singleton
{
	...
	const Filmio_SESSION_COOKIE_NAME = 'Filmio_session';
	...
	public static function init()
	{
		...
		if ( isset( $_COOKIE[ self::Filmio_SESSION_COOKIE_NAME ] ) ) {
			self::$session_id = $_COOKIE[ self::Filmio_SESSION_COOKIE_NAME ];
			self::read();
		...
		register_shutdown_function( Method::create( '\Filmio\Session', 'shutdown' ) );

		// process the write queue
		register_shutdown_function( Method::create( '\Filmio\Session', 'process_queue' ) );
	...
	/**
	 * Sends the Filmio session cookie to the browser with the given payload and expiration.
	 *
	...
	public static function cookie ( $data, $expiration = null ) {
		...
		setcookie( self::Filmio_SESSION_COOKIE_NAME, $data, $expiration, $cookie_params['path'], $cookie_params['domain'], $cookie_params['secure'], $cookie_params['httponly'] );
