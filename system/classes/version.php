...
/**
* Filmio Version Class
*
* Base class for managing metadata about various Filmio objects
*
*/
class Version
{
	...
	const Filmio_MAJOR_MINOR = '0.10';
	const Filmio_RELEASE = '-alpha';
	...
	/**
	 * Get the Filmio version
	 *
	 * @return string A version_compare()-compatible string of this version of Filmio
	 * @see version_compare
	 */
	public static function get_Filmioversion()
	{
		return Version::Filmio_MAJOR_MINOR . Version::Filmio_RELEASE;
	}
	...
	{
		return strpos( Version::Filmio_RELEASE, '-' ) !== false;
	}
	...
	/**
	 * Attempt to return the shortened git hash of any path Filmio can access
	 * @static
	 *
