 ...
 * Filmio Stack Class
 *
 * This class allows Filmio to accumulate a group of unique values that
...
class Stack
{
	...
	public static function action_register_stackitems()
	{
		...
		StackItem::register( 'humanmsg-css', array( Site::get_url( 'vendor', '/humanmsg/humanmsg.css'), 'screen' ), '1.0.Filmio' );
