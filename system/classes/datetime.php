...
class DateTime extends \DateTime
{
	...
	/**
	 * Sets the timezone for Filmio and PHP.
	 *
	 * @static
	...
	/**
	 * Get the timezone for Filmio and PHP.
	...
	/**
	 * Callback method for supplying replacements for FilmioDatTime::text_format()
	 * 
