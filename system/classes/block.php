...
class Block extends QueryRecord implements IsContent, FormStorage
{
	...
	public function insert()
	{
		...
		EventLog::log( _t( 'New block %1$s: %2$s', array( $this->id, $this->title ) ), 'info', 'content', 'filmio' );
	...
	public function delete()
	{
		...
		EventLog::log( _t( 'Block %1$s (%2$s) deleted.', array( $this->id, $this->title ) ), 'info', 'content', 'filmio' );
